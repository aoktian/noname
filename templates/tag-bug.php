...
<select name="row[pro]" onchange="onChangePro( this.value, '#filterTags', '版本' );" class="form-control">
...
<div class="form-group">
<select name="row[department]" class="form-control" onchange="onChangeDepartment( this.value, '#slt-leaders', '部门' )">
...
<div class="form-group">
<select name="row[leader]" class="form-control"  id="slt-leaders">
