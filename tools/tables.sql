...
CREATE TABLE IF NOT EXISTS `tasklogs` (
  ...
  `caty` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `priority` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `pro` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `leader` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `tester` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `changer` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `deadline` int(11) NOT NULL DEFAULT '0',
  `created_at` timestamp,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `golist_task` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `golist_taskg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS `golist_taskgs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `gid` int(10) NOT NULL,
  `tid` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `golist_one` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `modid` int(10) NOT NULL,
  `r` int(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `modid_index` (`modid`)
) ENGINE=MyISAM AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS `golist_ones` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `oid` int(10) NOT NULL,
  `tid` int(10) NOT NULL DEFAULT 0,
  `isdo` tinyint(4) NOT NULL DEFAULT 1,
