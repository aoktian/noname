...
class Controller extends Middle_Public {
    public function index() {
        ...
        $this->_page();
        $this->view->html('tag-list');
    }

    public function page() {
        $this->_page();
        $this->view->render('tag-list-content');
    }
    ...
    private function _index() {
        ...
        return $this->view->redirect('/tag/index?pro=' . $pro . '&page=' . $curpage);
    }
    ...
    public function stats() {
        ...
        return $this->view->html('tag-statistics', [
            'tag'          => $tag,
